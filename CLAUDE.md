...
- `src/components/Slide/AnalysisProgress.tsx` — four-segment progress bar with a stage label (*No começo…* → *Última lâmina*) and an info tooltip; `SlideView/SlideArrow.tsx` is the full-height back/next arrow.
